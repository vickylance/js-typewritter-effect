...
var Logo = _interopRequireWildcard(require("./logo.svg"));
...
/*#__PURE__*/
function () {
  function TypeWriter(elem, words) {
  ...
  _createClass(TypeWriter, [{
    ...
    value: function type() {
      ...
      var fullTxt = this.words[current]; // set txt according to isDeleting
      ...
      this.elem.innerHTML = "<span class=\"typewriter-txt\">".concat(this.txt, "</span>"); // Initial Type Speed
      ...
      if (!this.isDeleting && this.txt === fullTxt) {
        ...
        // start of word
        this.isDeleting = false; // pause before starting to type

        typeSpeed = 500; // next word
...
var startTypeWriter = function startTypeWriter() {
  ...
  var words = JSON.parse(elem.getAttribute("data-words"));
  var delay = elem.getAttribute("data-delay");
  new TypeWriter(elem, words, delay);
};

document.addEventListener("DOMContentLoaded", startTypeWriter);
},{"./style.scss":"style.scss","./logo.svg":"logo.svg"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/typewriter.e31bb0bc.js.map